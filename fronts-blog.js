		...
		const renderPage = (innerContent, showTitle = true) => {
			...
			document.body.innerHTML = `
							...
							<div class="col-xs-4 col-md-6 col-lg-8">
								<div class="logo-brand text-center">
									<a href="/" class="mh-auto">
										<img id="main-logo" src="https://cdn.statically.io/gh/digiitaltools/newsgo@main/ipotnews/img/n1_ipotnews.png" class="img-responsive hidden-xs hidden-sm mh-auto">
									</a>

									<a href="/" class="mh-auto">
										<img id="main-logo-mobile" src="https://cdn.statically.io/gh/digiitaltools/newsgo@main/ipotnews/img/n1_ipotnews_w.png" class="img-responsive visible-xs visible-sm mh-auto">
									</a>
								</div>
							</div>
				...
				<div class="clearfix mm-page mm-slideout">
					...
					<footer class="footer pt20 pb20 bgcolor-gray" style="border-top: 1px solid #eee; margin-top: 50px;">
		...
		const loadHome = async () => {
			try {
				...
				if (result.status === "success") {
					...
					renderPage(`<div class="listMoreLeft divColumn" id="news-list news-grid">${listHtml}</div>`, true);
